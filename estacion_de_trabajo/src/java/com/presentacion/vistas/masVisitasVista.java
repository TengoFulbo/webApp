...
import turismouy.svcentral.datatypes.*;
...
public class masVisitasVista extends JPanel {

	private String selectedTheme;

	public masVisitasVista(String tema) {
        ...
        JLabel titulo = new JLabel("Actividades y Salidas mas visitadas");
        titulo.setBounds(0, 0, 671, 40);
        titulo.putClientProperty("FlatLaf.styleClass", "h1");
        center.add(titulo);
        
        JLabel descripcion = new JLabel("Lista de Actividades/Salidas mas visitadas");
